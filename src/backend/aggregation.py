...
# Create SQL table for the table of raw comments with topics.
df_nmf_all = load_nlp_data(file_setting.get("NMF_ALL_DATA"))
df_nmf_all.to_sql(name="raw_comments", con=engine, if_exists="replace")
